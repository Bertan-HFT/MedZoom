...
import 'p_u_patient_suchen_model.dart';
export 'p_u_patient_suchen_model.dart';

class PUPatientSuchenWidget extends StatefulWidget {
  const PUPatientSuchenWidget({Key? key}) : super(key: key);

  @override
  _PUPatientSuchenWidgetState createState() => _PUPatientSuchenWidgetState();
}

class _PUPatientSuchenWidgetState extends State<PUPatientSuchenWidget> {
  late PUPatientSuchenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PUPatientSuchenModel());
