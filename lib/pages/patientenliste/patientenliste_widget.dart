...
import 'patientenliste_model.dart';
export 'patientenliste_model.dart';

class PatientenlisteWidget extends StatefulWidget {
  const PatientenlisteWidget({Key? key}) : super(key: key);

  @override
  _PatientenlisteWidgetState createState() => _PatientenlisteWidgetState();
}

class _PatientenlisteWidgetState extends State<PatientenlisteWidget>
    with TickerProviderStateMixin {
  late PatientenlisteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientenlisteModel());
