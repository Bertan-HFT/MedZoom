...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF008DFF);
  late Color secondary = const Color(0xFFFF8C00);
  late Color tertiary = const Color(0xFFFF8C69);
  ...
  late Color accent2 = const Color(0xFF9400D3);
  late Color accent3 = const Color(0xFF00FF7F);
  late Color accent4 = const Color(0xFF1E90FF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF005F5F);
  late Color secondary = const Color(0xFFD47C00);
  late Color tertiary = const Color(0xFFFF8C69);
  late Color alternate = const Color(0xFF1C1C1C);
  late Color primaryText = const Color(0xFFF5F5F5);
  late Color secondaryText = const Color(0xFFBFBFBF);
  late Color primaryBackground = const Color(0xFF1C1C1C);
  late Color secondaryBackground = const Color(0xFF2B2B2B);
  late Color accent1 = const Color(0xFFFF8C00);
  late Color accent2 = const Color(0xFFBA55D3);
  late Color accent3 = const Color(0xFF7FFF00);
  late Color accent4 = const Color(0xFF00BFFF);
  late Color success = const Color(0xFF32CD32);
  late Color warning = const Color(0xFFFFA500);
  late Color error = const Color(0xFFDC143C);
